    ...
    return (
        ...
        <div className="partners--container">
            <div className="row row1">
                ...
                <img src={ebay} alt="" className="img img14"/>
                <img src={facebook} alt="" className="img img15"/>
                <img src={google} alt="" className="img img16"/>
                <img src={dwell} alt="" className="img img17"/>
